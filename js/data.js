...
const APPLIANCE_CATALOG = {
  ...
  'washer-lg-wm4200': {
    ...
    guides: {
      unbox: {
        video_id: 'JcNjBlS1XFc',
        video_title: 'LG Washing Machine — Unboxing & Setup (Official)',
        steps: [
      ...
      install: {
        video_id: 'oMfOGfquoDA',
        video_title: 'How to Install a Front Load Washing Machine',
        steps: [
  ...
  'heatpump-mitsubishi-msz': {
    ...
    guides: {
      unbox: {
        video_id: 'y8Q6WHJ8Jdc',
        video_title: 'Mitsubishi Heat Pump — What\'s in the Box',
        steps: [
  ...
  'dishwasher-bosch-sms4': {
    ...
    guides: {
      unbox: {
        video_id: 'n7OOfb3UGKg',
        video_title: 'Bosch Dishwasher — Unboxing & First Use',
        steps: [
